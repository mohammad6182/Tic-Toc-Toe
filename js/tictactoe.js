// this varieble keeps track of whose turn it is.
let activePlayer ='X';
//this array stores an array of moves. we use this to detarmane win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(Element => Element.includes(squareNumber))) {
        ...
        //squareNumber and activePlayr are concatenated together and added to array.
        ...
        function computersTurn() {
            ...
            while(!success) {
                ...
                function checkWinConditions() {
                    ...
                    // this function checks if an array includes 3 strings. it is used to chech for
                    //each win conditions
                ...
                function audio(audioURL) {
                    ...
                    //playe methods plays our audio sound.
                    audio.play();
                }
                ...
                function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
                    ...
                    // this line give us access to methods and properties tp use on canvas.
                    const c = canvas.getContext('2d');
                    //this line indicates where the start of a line x axis is
                    let x1 = coordX1,
                    // this line indicates where the start of y axis is.
                     y1 = coordY1, 
                     //this line indicates where the end of line x is
                     x2= coordX2,
                     // this line indicates where the end of line x axis is
                     y2= coordY2,
                     //this varieble stores temporary x axis data we update in our animation loop
                     x=x1,
                     //this varieble stores temporary y axis data we update in our animation loop
                     y=y1;
                     ...
                     function animateLineDrawing() {
                        ...
                        c.moveTo(x1,y1);
                        //this method indicates the end pioint in our line
                        c.lineTo(x,y);
                        // this method sets the width of our line
                        c.lineWidth = 10;
                        //this methods will sets the color of our line
                     ...
                     // this function clears our canvas after our win kine is drawn
                     function clear() {
                     ...
                     animateLineDrawing();
                     // this line waits 1 seconds then clears canvas reset games and allow clicking again
